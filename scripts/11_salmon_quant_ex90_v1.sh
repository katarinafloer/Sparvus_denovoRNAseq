#!/bin/bash
#SBATCH --job-name=salmon_quant_ex90_v1
#SBATCH --nodelist=cpu[069-079]
#SBATCH --nodes=1
#SBATCH --cpus-per-task=16
#SBATCH --mem=64G
#SBATCH --time=8:00:00
#SBATCH --output=/home/kfloer_smith_edu/03_26_flut_rnaseq/job_logs/%j.salmon_quant_ex90_v1.out
#SBATCH --error=/home/kfloer_smith_edu/03_26_flut_rnaseq/job_logs/%j.salmon_quant_ex90_v1.err
...
QUANT_DIR="$TMP_DIR/salmon_quant_ex90_v1"
...
echo "[salmon_quant_ex90_v1] Index:       $INDEX_DIR"
echo "[salmon_quant_ex90_v1] Left reads:  $ALL_LEFT"
echo "[salmon_quant_ex90_v1] Right reads: $ALL_RIGHT"
echo "[salmon_quant_ex90_v1] Output:      $QUANT_DIR"
echo "[salmon_quant_ex90_v1] Running Salmon quantification..."
