#!/bin/bash
#SBATCH --job-name=ex90n50_v3_50bp_filter
...
#SBATCH --mem=16G
#SBATCH --time=2:00:00
#SBATCH --output=/home/kfloer_smith_edu/03_26_flut_rnaseq/job_logs/%j.ex90n50_v3_50bp.out
#SBATCH --error=/home/kfloer_smith_edu/03_26_flut_rnaseq/job_logs/%j.ex90n50_v3_50bp.err
...
# ---- Input ----
TRINITY_FASTA="$TMP_DIR/filtered_assembly_v3_50bp/Trinity.TPM1.fasta"
FULL_MATRIX="$TMP_DIR/filtered_assembly_v3_50bp/salmon.isoform.TPM.not_cross_norm"
EX90_OUT="$TMP_DIR/ex90n50_v3_50bp_filtered"
...
echo "[ex90n50_v3_50bp_filtered] Assembly:      $TRINITY_FASTA"
echo "[ex90n50_v3_50bp_filtered] Full matrix:   $FULL_MATRIX"
echo "[ex90n50_v3_50bp_filtered] Filtered mat:  $FILTERED_MATRIX"
echo "[ex90n50_v3_50bp_filtered] Output:        $EX90_OUT"
...
echo "[ex90n50_v3_50bp_filtered] Calculating ExN50 stats..."
...
echo "========================================"
echo "[ex90n50_v3_50bp_filtered] Complete. Full stats: $EX90_OUT/ExN50_stats.txt"
