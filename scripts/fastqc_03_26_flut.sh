...
#SBATCH --output=/home/kfloer_smith_edu/03_26_flut_rnaseq/job_logs/%A_%a.fastqc.out
#SBATCH --error=/home/kfloer_smith_edu/03_26_flut_rnaseq/job_logs/%A_%a.fastqc.err
