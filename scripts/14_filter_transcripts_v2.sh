...
# ---- Directories ----
FILTER_DIR="$TMP_DIR/filtered_assembly_v3_50bp"

QUANT_DIR="$TMP_DIR/salmon_quant_v3_50bp"

mkdir -p "$FILTER_DIR" "$LOG_DIR"

# ---- Input ----
TRINITY_FASTA="$TRINITY_V3_50BP_FASTA"
GENE_TRANS_MAP="$TRINITY_V3_50BP_GENE_MAP"
